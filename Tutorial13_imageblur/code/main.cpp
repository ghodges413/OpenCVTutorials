...
int Image() {
	...
	const char * window_name = "The Photo"; 
	const char * window_name_blurred_with_3x3_kernel = "The Photo Blurred with 3 x 3 Kernel";
	const char * window_name_blurred_with_5x5_kernel = "The Photo Blurred with 5 x 5 Kernel";
...
int Video() {
	...
	const char * window_name_of_video_blurred_with_5x5_kernel = "Video Blurred with 5 x 5 Kernel";
	...
	while ( 1 ) {
		...
		cv::blur( frame, frame_blurred_with_5x5_kernel, cv::Size( 5, 5 ) );
